...
public class SampleSchedulingService extends IntentService {
    public SampleSchedulingService() {
        super("SampleSchedulingService");

        Log.d("Resulted", "Into SampleSchedulingService");
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        Log.d("Resulted", "Into onHandleIntent");
        ...
        try {
            Log.d("Resulted", "Into try block");
            //constants
            URL url = new URL("http://techndevs.us/clients/ashfaq/AutoUpdater/version.php");
            ...
            Log.d("Resulted", "Response ==> " + response.toString());
            ...
            if (serverversion > currentversionCode) {
                Log.d("Resulted", "Condition is TRUE");
